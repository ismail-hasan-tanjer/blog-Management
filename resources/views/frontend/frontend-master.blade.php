...
<html lang="en-us"><head>
  <meta charset="utf-8">
  <title>Reader | Blog Template</title>
...
<section class="section-sm">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('/')}}frontend/images/post/post-3.jpg" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('/')}}frontend/images/post/post-7.jpg" class="card-img-top" alt="post-thumb">
  </div>
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('/')}}frontend/images/post/post-8.jpg" class="card-img-top" alt="post-thumb">
      <img src="{{asset('/')}}frontend/images/post/post-9.jpg" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and Cashmere Recipe At Home</a></h3>
      <ul class="card-meta list-inline">
  ...
  <div class="widget widget-about">
    ...
    <img class="img-fluid" src="{{asset('/')}}frontend/images/author.jpg" alt="Themefisher">
  ...
  <!-- Promotion -->
  <div class="promotion">
    <img src="{{asset('/')}}frontend/images/promotion.jpg" class="img-fluid w-100">
  ...
  <div class="widget widget-author">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('/')}}frontend/images/john-doe.jpg">
      </div>
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('/')}}frontend/images/kate-stone.jpg">
      </div>
      <div class="media-body">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('/')}}frontend/images/john-doe.jpg" alt="John Doe">
      </div>
      <div class="media-body">
  ...
  <div class="widget">
    ...
    <article class="widget-card">
      <div class="d-flex">
        <img class="card-img-sm" src="{{asset('/')}}frontend/images/post/post-10.jpg">
        <div class="ml-3">
...
<footer class="footer">
  ...
  <div class="instafeed text-center mb-5">
      ...
      <div class="instagram-slider">
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/1.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/2.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/4.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/3.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/2.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/1.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/3.jpg"></div>
        <div class="instagram-post"><img src="{{asset('/')}}frontend/images/instagram/4.jpg"></div>
  ...
  <div class="container">
      ...
      <div class="col-md-2 text-center mb-4">
          <a href="index.html"><img class="img-fluid" width="100px" src="{{asset('/')}}frontend/images/logo.png" alt="Reader | Hugo Personal Blog Template"></a>
      </div>
